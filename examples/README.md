...
Real, unedited fabma output — same brief, one generation each, different providers and art directions. Open the files in a browser (or at `/examples/<file>` when fabma is running).

**Brief (locked content):** *"A landing hero for Brewday, a small-batch coffee subscription for developers. Tagline about shipping and sipping. One CTA: Start brewing."* Mode: section.

| File | Provider | Art direction |
| --- | --- | --- |
